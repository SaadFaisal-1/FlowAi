...
Google Sheets, Gmail, and Calendar can also be connected through:
...
For Sheets, share the spreadsheet with the service account `client_email`. For Gmail and Calendar, use OAuth authorized-user JSON unless your Google Workspace service account has domain-wide delegation.
